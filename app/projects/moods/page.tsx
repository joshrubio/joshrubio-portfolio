                                ...
                                <div className="col-lg-8 mx-lg-auto mt-8">
                                    ...
                                    <div className="p-4 bg-light rounded-3 mt-4">
                                        ...
                                        <ul className="text-300 mb-0" style={{ color: '#333' }}>
                                            <li className="mb-2">
                                                <strong style={{ color: '#333' }}>Analyze User Interaction Trends:</strong> Review how users engage with social features in existing music-driven apps to inform MOODS' design.
                                            </li>
                                            <li className="mb-2">
                                                <strong style={{ color: '#333' }}>Identify Motivations for Social Engagement:</strong> Investigate user motivations behind music-based social interactions to guide MOODS' feature development.
                                            </li>
                                            <li className="mb-0">
                                                <strong style={{ color: '#333' }}>Assess Social Features' Impact on Retention:</strong> Study the effect of social elements on user retention in similar platforms to predict MOODS' potential impact.
                                            </li>
                                        </ul>
                                    </div>
