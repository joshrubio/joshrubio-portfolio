							...
							<div className="col-lg-4 offset-lg-1">
								...
								<div className="d-flex flex-column gap-2 mt-9 position-relative z-1">
									<Link href="tel:+12345678901">
										...
										<span className="text-300 fs-6 ms-2">+34-643-529-116</span>
									</Link>
									<Link href="mailto:joshuerubio@gmail.com">
										<i className="ri-mail-fill text-primary-3 fs-7" />
										<span className="text-300 fs-6 ms-2">joshuerubio@gmail.com</span>
									</Link>
									<Link href="#">
										<i className="ri-skype-fill text-primary-3 fs-7" />
										<span className="text-300 fs-6 ms-2">joshuerubio</span>
									</Link>
